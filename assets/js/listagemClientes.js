...
function exibirDados(page) {
    ...
    page.content.forEach(function(cliente) {
        var clienteHtml = "<thead><tr><th>CPF</th><th>Nome</th><th>Email</th><th>Telefone</th><th class='acoes'>Ações</th></tr></thead>";
        ...
        clienteHtml += "<td><button>Alterar</button><button>Excluir</button></td></tr></tbody>";
